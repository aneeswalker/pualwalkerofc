...
module.exports = bosco = async (bosco, mek) => {
	try {
		...
		const catl = (teks) => {
             res = bosco.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 400, "message": teks, "footerText": "*Anees Ser*", "thumbnail": dfrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             bosco.relayWAMessage(res)
        }
       const catlo = (teks) => {
             res = bosco.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 70000, "message": teks, "footerText": "Made With Anees", thumbnail: fs.readFileSync('./ds.jpg'), "surface": 'CATALOG' }}, {quoted:mek})
             bosco.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = bosco.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '6288213840883-1616169743@g.us', "inviteCode": 'https://chat.whatsapp.com/Dgt6JhzTvlmEor8Zz23fHx', "groupName": `Bosco Family`, "footerText": "*Anees Ser*", "jpegThumbnail": dfrply, "caption": teks}}, {quoted:fvideo})
        ...
        const reply = (teks) => {
	      bosco.sendMessage(from, teks, text, { thumbnail: denis, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: false, "externalAdReply": { "title": `${' '}𝐴𝑁𝐸𝐸𝑆 𝑆𝐸𝑅 𝐵𝑂𝑇 : 𝑉1${''}${''}`, "body": `𝑃𝑅𝐼𝑉𝐴𝑇𝐸 𝐵𝑂𝑇`, "previewType": 'PHOTO', "thumbnailUrl": `${''}`, "thumbnail": denis, "sourceUrl": `${''}`}},})
        }
...
// AUTO
			...
			for (let anju of vien){
				if (budy === anju){
					...
					bosco.sendMessage(from, result, audio, { quoted: mek, mimetype: 'audio/mp4', duration: 666666666, ptt: true, contextInfo: { forwardingScore: 500, isForwarded: true}})
					}
			}
      ...
      const sendWebp = async(to, url) => {
       ...
       const sendMediaURL = async(to, url, text="", mids=[]) =>{
           ...
           bosco.sendMessage(to, media, type, {quoted: mek, "externalAdReply": { "title": `${' '}𝐴𝑁𝐸𝐸𝑆 𝑆𝐸𝑅 𝐵𝑂𝑇 : 𝑉1${''}${''}`, "body": `𝑃𝑅𝐼𝑉𝐴𝑇𝐸 𝐵𝑂𝑇`, "previewType": 'PHOTO', "thumbnailUrl": `${''}`, "thumbnail": denis, "sourceUrl": `${''}`}, mimetype: mime, caption: text, thumbnail: Buffer.alloc(0), contextInfo: {"mentionedJid": mids}})
...
│❖ *ʀᴇᴄᴏᴅᴇ : 𝙰𝙽𝙴𝙴𝚂*
│❖ *ɪɴꜱᴛᴀ : 𝚂𝚢𝚗𝚣𝚇_𝙽𝙱𝚡*
│❖ *ᴡʜsᴛᴘ : Wa.me/917356378949*
╰────────────────❋ཻུ۪۪⸙
⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘
               𝙰𝙽𝙴𝙴𝚂 𝚂𝙴𝚁

╭◪ *⋆ᴜsᴇ .ᴍᴇɴᴜ  𝙰𝙽𝙴𝙴𝚂 𝚂𝙴𝚁❦︎⋆*
╰─────────────────❋ཻུ۪۪⸙
 𓅂𝙷𝙸 𝙱𝚁𝙾 @${sender.split("@")[0]}
 𓅂𝙿𝚁𝙸𝚅𝙰𝚃𝙴 : ${privat.length}
 𓅂𝙶𝚁𝙾𝚄𝙿 : ${groups.length}
 𓅂𝚃𝙾𝚃𝙰𝙻 : ${totalChat.length}
 𓅂𝚂𝙿𝙴𝙴𝙳 : ${latensie.toFixed(4)}
 𓅂𝙱𝙰𝚃𝚃𝙴𝚁𝚈 : ${baterai}%\n
 ${jmn} -  ${jmo}\n${week} - ${calender}
 `
...
break
      case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						reply(`*𝐵𝑅𝑂𝐴𝐷𝐶𝐴𝑆𝑇 𝑆𝑈𝐶𝐶𝐸𝑆𝑆* ${body.slice(4)}`)
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `${body.slice(4)}`)
						}
						reply(`*𝐵𝑅𝑂𝐴𝐷𝐶𝐴𝑆𝑇 𝑆𝑈𝐶𝐶𝐸𝑆𝑆*:\n${body.slice(4)}`)
					}
					break
       case 'contact':
...
teks = `
*𝙽𝙹𝙰𝙽 𝚄𝙽𝙳 𝙴𝚅𝙸𝙳𝙴🌺 :)*
*𝚂𝙿𝙴𝙴𝙳 :* ${latensie.toFixed(4)} Second
*𝚁𝙰𝙼 𝚄𝚂𝙴𝙶𝙴 :* ${ram2}
*𝙱𝙰𝚃𝚃𝙴𝚁𝚈 :* ${baterai}% ${charger}
*𝙿𝙻𝙰𝚃𝙵𝙾𝚁𝙼 :* ${os.platform()}
*𝚄𝙿𝚃𝙸𝙼𝙴 :* ${runtime(process.uptime())}
*𝚆𝙰 𝚅𝙴𝚁𝚂𝙸𝙾𝙽 :* ${bosco.user.phone.wa_version}
*𝙾𝚂 𝚅𝙴𝚁𝚂𝙸𝙾𝙽 :* ${bosco.user.phone.os_version}
*𝙳𝙴𝚅𝙸𝙲𝙴 𝙼𝙰𝙽𝚄𝙵𝙰𝙲𝚃𝚄𝚁𝙴 :* ${bosco.user.phone.device_manufacturer}
*𝙳𝙴𝚅𝙸𝙲𝙴 𝙼𝙾𝙳𝙴𝙻 :* ${bosco.user.phone.device_model}
`
    menubutton = [{buttonId:`${prefix}credits`,buttonText:{displayText:'CREDITS'},type:1}
]
 menumessage = { contentText: `${teks}`, footerText: `𝐴𝑁𝐸𝐸𝑆 𝑆𝐸𝑅 𝐵𝑂𝑇 𝑉1`, buttons: menubutton, headerType: 6, locationMessage: bosco2.message.locationMessage}
...
//------------------< Storage >-------------------
	 ...
	 case 'delvn':
				...
				case 'listbgm':
					...
					teks += `\n*Tᴏᴛᴀʟ : ${vien.length}*\n\n_🌹_`
					bosco.sendMessage(from, teks.trim(), extendedText, { caption: 'teks', "contextInfo": { text: 'teks', sendEphemeral: true, "externalAdReply": { "title": `${' '}𝐴𝑁𝐸𝐸𝑆 𝑆𝐸𝑅${''}${''}`, "body": ``, "previewType": 'PHOTO', "thumbnailUrl": `${'https://i.ibb.co/vkkcm0L/034c588fd8d5.jpg'}`, "thumbnail": '', "sourceUrl": `${'https://wa.me/c/917356378949'}`}},quoted: ftext})
					break
				case 'addimage':
